...
const PatientRegistration = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5267/patient-register', formData);
  ...
  const insuranceOptions = ['Private', 'Medicare', 'Medicaid', 'None', 'Other'];
    ...
    <div className="registration-container">
      <div className="registration-card">
        <div className="registration-header">
          <img src={patientIcon} alt="Patient" className="registration-icon" />
        </div>
          ...
          <div className="form-row">
            <div className="form-group half">
              ...
              <select
                ...
                required
              >
                <option value="" disabled>Blood</option>
